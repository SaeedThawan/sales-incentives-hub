/**
 * محرك احتساب الأداء وبوابات الاستحقاق الحسابية الدقيقة - v17.0
 */
...
const CalcEngine = {
  processRepData(rep, generalRules, groupRules) {
    ...
    // 4. تطبيق شرط الاستحقاق الحازم: إذا كان عدد المجموعات < 7 تصبح العمولة 0 ر.س
